...
import {
    T as TrianglesDrawMode,
    a as TriangleFanDrawMode,
    b as TriangleStripDrawMode,
    L as Loader,
    c as LoaderUtils,
    F as FileLoader,
    C as Color,
    d as LinearSRGBColorSpace,
    S as SpotLight,
    P as PointLight,
    e as DirectionalLight,
    M as MeshBasicMaterial,
    f as SRGBColorSpace,
    h as MeshPhysicalMaterial,
    i as Vector2,
    j as Matrix4,
    k as Vector3,
    Q as Quaternion,
    I as InstancedMesh,
    l as InstancedBufferAttribute,
    O as Object3D,
    m as TextureLoader,
    n as ImageBitmapLoader,
    B as BufferAttribute,
    o as InterleavedBuffer,
    p as InterleavedBufferAttribute,
    q as LinearFilter,
    r as LinearMipmapLinearFilter,
    R as RepeatWrapping,
    N as NearestFilter,
    s as PointsMaterial,
    u as Material,
    v as LineBasicMaterial,
    w as MeshStandardMaterial,
    x as DoubleSide,
    y as PropertyBinding,
    z as BufferGeometry,
    A as SkinnedMesh,
    E as Mesh,
    G as LineSegments,
    ...
    Y as MathUtils,
    Z as OrthographicCamera,
    _ as Skeleton,
    $ as AnimationClip,
    a0 as Bone,
    a1 as InterpolateLinear,
    a2 as ColorManagement,
    a3 as NearestMipmapNearestFilter,
    a4 as LinearMipmapNearestFilter,
    a5 as NearestMipmapLinearFilter,
    a6 as ClampToEdgeWrapping,
    a7 as MirroredRepeatWrapping,
    a8 as InterpolateDiscrete,
    a9 as FrontSide,
    aa as Texture,
    ab as VectorKeyframeTrack,
    ac as NumberKeyframeTrack,
    ad as QuaternionKeyframeTrack,
    ae as Box3,
    af as Sphere,
    ag as Interpolant,
...
class GLTFMaterialsVolumeExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        materialParams.thickness =
            extension.thicknessFactor !== void 0
...
class GLTFParser {
    ...
    _loadNodeShallow(nodeIndex) {
        ...
        this.nodeCache[nodeIndex] = Promise.all(pending).then(function (
            objects
        ) {
            let node;
...
class DRACOLoader extends Loader {
    ...
    _createGeometry(geometryData) {
        ...
        for (let i = 0; i < geometryData.attributes.length; i++) {
            const { name, array, itemSize, stride, vertexColorSpace } =
                geometryData.attributes[i];
            let attribute;
            if (itemSize === stride) {
...
function DRACOWorker() {
    ...
    function decodeAttribute(
        ...
        if (srcByteStride === dstByteStride) {
            ...
            dstArray = new TypedArray(
                dstByteLength / TypedArray.BYTES_PER_ELEMENT
            );
            let dstOffset = 0;
...
export { GltfLoader as G };
//# sourceMappingURL=gltfLoader.a307dfed.js.map
