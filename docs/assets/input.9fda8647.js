...
import {
    B as BimOpenSchemaLoader,
    l as loadBimGeometryFromZip,
} from './bimOpenSchemaLoader.8135e0a5.js';
class GizmoOptions {
    constructor(init) {
        ...
        this.bubbleSizePrimary =
            init?.bubbleSizePrimary ?? this.bubbleSizePrimary;
...
const ARA3D = /* @__PURE__ */ Object.freeze(
...
console.log(ARA3D);
//# sourceMappingURL=input.9fda8647.js.map
