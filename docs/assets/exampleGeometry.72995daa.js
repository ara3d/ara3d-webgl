import {
    V as Viewer,
    ak as SphereGeometry,
    al as IcosahedronGeometry,
    am as OctahedronGeometry,
    an as TetrahedronGeometry,
    ao as PlaneGeometry,
    ap as BoxGeometry,
    aq as CircleGeometry,
    ar as RingGeometry,
    as as CylinderGeometry,
    at as ConeGeometry,
    au as TorusGeometry,
    av as TorusKnotGeometry,
    ...
    const materials = geometries.map(
        (_, i) =>
            new MeshStandardMaterial({
                color: new Color(
                    `hsl(${((i * 360) / geometries.length).toFixed(
                        0
                    )}, 60%, 50%)`
                ),
